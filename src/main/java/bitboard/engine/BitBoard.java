...
import bitboard.generators.MoveGenerator;
...
public class BitBoard implements IBoard {
    ...
    private @Getter @Setter BitBoardState currentState;
    private @Getter MoveGenerator moveGenerator;
    private @Getter String fenString;

    public BitBoard() {
        this.moveGenerator = new LegalMoveGenerator(new PreCalculatedData());
    ...
    public void setStateFromFenString(String fenString) {
        this.currentState = fenStringToBitBoardState(fenString);
    }
